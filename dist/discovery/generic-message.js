...
exports.buildGenericCIPMessage = buildGenericCIPMessage;
const MessageRouter = __importStar(require("../cip/message-router"));
const epath_1 = require("../cip/epath");
function buildGenericCIPMessage(service, classId, instance, attribute, data) {
    const builder = new epath_1.EPathBuilder()
        .logical(epath_1.LogicalType.ClassID, classId)
        .logical(epath_1.LogicalType.InstanceID, instance);
    if (attribute !== undefined) {
        builder.logical(epath_1.LogicalType.AttributeID, attribute);
    }
